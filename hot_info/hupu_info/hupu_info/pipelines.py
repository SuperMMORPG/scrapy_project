...
class HupuInfoPipeline:
    ...
    def process_item(self, item, spider):
        ...
        title = item['hupu_title']
        url = item['hupu_url']
        rank = item['hupu_ranking']
...
class mysqlHupuInfoPipeline(object):

    conn = None
    cursor = None
    def open_spider(self,spider):
        print('#############################')
        print('准备连接数据库，开始hupu任务...')
        print('#############################')
    ...
    def process_item(self, item, spider):
        ...
        try:
            ...
            mysql_execute = 'INSERT INTO hupu (ranking,url,title) VALUES ("%s","%s","%s");'
            url = item['hupu_url']
            ranking = item['hupu_ranking']
            title = item['hupu_title']
